 ...
 */
import type { CreatePrivateDeployKeyApplicationBodiesBuildPack } from "./create-private-deploy-key-application-bodies-build-pack";
import type { CreatePrivateDeployKeyApplicationBodiesRedirect } from "./create-private-deploy-key-application-bodies-redirect";
import type { CreatePrivateDeployKeyApplicationBodiesStaticImage } from "./create-private-deploy-key-application-bodies-static-image";

export type CreatePrivateDeployKeyApplicationBodies = {
  /** The project UUID. */
  project_uuid: string;
  /** The server UUID. */
  server_uuid: string;
  ...
  /** The build pack type. */
  build_pack: CreatePrivateDeployKeyApplicationBodiesBuildPack;
  ...
  is_static?: boolean;
  /** The static image. */
  static_image?: CreatePrivateDeployKeyApplicationBodiesStaticImage;
  /** The install command. */
   ...
   * @nullable
   */
  redirect?: CreatePrivateDeployKeyApplicationBodiesRedirect;
