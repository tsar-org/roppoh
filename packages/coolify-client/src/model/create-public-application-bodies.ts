 ...
 */
import type { CreatePublicApplicationBodiesBuildPack } from "./create-public-application-bodies-build-pack";
import type { CreatePublicApplicationBodiesRedirect } from "./create-public-application-bodies-redirect";
import type { CreatePublicApplicationBodiesStaticImage } from "./create-public-application-bodies-static-image";

export type CreatePublicApplicationBodies = {
  /** The project UUID. */
  project_uuid: string;
  /** The server UUID. */
  server_uuid: string;
  ...
  git_branch: string;
  /** The build pack type. */
  build_pack: CreatePublicApplicationBodiesBuildPack;
  /** The ports to expose. */
  ...
  is_static?: boolean;
  /** The static image. */
  static_image?: CreatePublicApplicationBodiesStaticImage;
  /** The install command. */
   ...
   * @nullable
   */
  redirect?: CreatePublicApplicationBodiesRedirect;
