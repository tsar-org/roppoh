 ...
 */
import type { UpdateApplicationByUuidBodiesBuildPack } from "./update-application-by-uuid-bodies-build-pack";
import type { UpdateApplicationByUuidBodiesRedirect } from "./update-application-by-uuid-bodies-redirect";

export type UpdateApplicationByUuidBodies = {
  /** The project UUID. */
  project_uuid?: string;
  /** The server UUID. */
  server_uuid?: string;
  ...
  /** The build pack type. */
  build_pack?: UpdateApplicationByUuidBodiesBuildPack;
   ...
   * @nullable
   */
  redirect?: UpdateApplicationByUuidBodiesRedirect;
