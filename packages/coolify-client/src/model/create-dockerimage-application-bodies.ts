 ...
 */
import type { CreateDockerimageApplicationBodiesRedirect } from "./create-dockerimage-application-bodies-redirect";

export type CreateDockerimageApplicationBodies = {
  /** The project UUID. */
  project_uuid: string;
  /** The server UUID. */
  server_uuid: string;
   ...
   * @nullable
   */
  redirect?: CreateDockerimageApplicationBodiesRedirect;
