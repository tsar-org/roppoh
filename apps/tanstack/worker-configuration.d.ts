/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: a2450ccfd681a515f229470bd3148a22)
// Runtime types generated with workerd@1.20250924.0 2025-09-02 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	...
	interface Env {
		...
		TSAR_GUILD_ID: string;
		BETTER_AUTH_SECRET: string;
		DISCORD_CLIENT_SECRET: string;
		COOLIFY_API_URL: string;
		COOLIFY_API_TOKEN: string;
		COOLIFY_CF_ACCESS_CLIENT_ID: string;
		COOLIFY_CF_ACCESS_CLIENT_SECRET: string;
		DOKPLOY_API_URL: string;
		DOKPLOY_API_TOKEN: string;
		ROPPOH_AUTH_DB: D1Database;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DISCORD_CLIENT_ID" | "TSAR_GUILD_ID" | "BETTER_AUTH_SECRET" | "DISCORD_CLIENT_SECRET" | "COOLIFY_API_URL" | "COOLIFY_API_TOKEN" | "COOLIFY_CF_ACCESS_CLIENT_ID" | "COOLIFY_CF_ACCESS_CLIENT_SECRET" | "DOKPLOY_API_URL" | "DOKPLOY_API_TOKEN">> {}
}
