/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 3f598649771bf3150c6162dc55b01e89)
// Runtime types generated with workerd@1.20260114.0 2025-10-08 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/entry");
		durableNamespaces: "AuthorizationCodeStore";
	}
	interface Env {
		KV: KVNamespace;
		...
		AUTH_CODE_STORE: DurableObjectNamespace<import("./src/entry").AuthorizationCodeStore>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DISCORD_CLIENT_ID" | "DISCORD_CLIENT_SECRET" | "DISCORD_REDIRECT_URL">> {}
}
