        ...
        children: [
          {
            children: [
              ...
              {
                lazy: {
                  Component: lazyDefault(async () => import("./pages/organization/page")),
                },
                path: "/organization",
              },
              {
                lazy: {
                  Component: lazyDefault(async () => import("./pages/user/page")),
                },
                path: "/user",
              },
              {
                lazy: {
                  Component: lazyDefault(async () => import("./pages/oidc-client/page")),
                },
                path: "/oidc-client",
              },
            ],
